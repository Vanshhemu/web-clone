  ...
  return (
    <div className="space-y-12">
      ...
      <div className="rounded-lg overflow-hidden shadow-lg h-96">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.8987449062697!2d77.06305!3d28.45595!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce2d0e1234567%3A0x1234567890abcdef!2sSavekey%20Technology!5e0!3m2!1sen!2sin!4v1234567890"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen
      ...
      <div className="space-y-8">
        ...
        <div className="bg-brand-light p-6 rounded-lg border-l-4 border-brand-primary">
          ...
          <p className="text-brand-primary font-bold text-lg mb-4">+91 9810980736 | +91 9810982503</p>
          <p className="text-gray-700 mb-2"><strong>For Sales:</strong> sales@savekeytechnology.com</p>
          <p className="text-gray-700"><strong>For HR:</strong> hr@savekeytechnology.com</p>
        </div>
      </div>
    </div>
  )
