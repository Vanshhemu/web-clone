          ...
          <div className="space-y-8">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <h3 className="text-2xl font-bold">Our <span className="text-brand-primary">Vision</span></h3>
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <h3 className="text-2xl font-bold">Our <span className="text-brand-primary">Mission</span></h3>
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4">We "Savekey Technology"</p>
              <p className="text-gray-700 leading-relaxed">
                <strong>A</strong> : Ambitious : Our leadership team strives to build a company
              </p>
              <button className="mt-6 bg-brand-primary text-white px-6 py-2 rounded hover:bg-brand-navy transition">
                Know More
              </button>
            </div>
          </div>
